...
namespace TouchScript
{
    ...
    public sealed class TouchManager : MonoBehaviour
    {
        ...
        {
            string stringBuilder = "Began\n";
            sendTouchInfo(stringBuilder, e);
        ...
        private void sendTouchInfo(String stringBuilder, TouchEventArgs e)
        {
            ...
            for (var i = 0; i < count; i++)
            {
                ...
                stringBuilder += "Id: ";
                stringBuilder += touch.Id;
                stringBuilder += "\n";
                stringBuilder += "Tags: ";
                stringBuilder += touch.Tags.ToString();

                stringBuilder += "\n";
                stringBuilder += "PosX: ";
                stringBuilder += touch.Position.x;
                stringBuilder += " / PosY: ";
                stringBuilder += touch.Position.y;
            }
            GetComponent<ClientUI>().sendData(stringBuilder);
        }
